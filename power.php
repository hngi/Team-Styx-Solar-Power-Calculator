				...
				<div class="card p-4" style="height: 100%">
					...
					<table class="table table-striped table-responsive">
						<tbody>
							...
							<tr>
								<td colspan="7">
									<strong><span style="font-weight: bold;">Sunlight Exposure per Day:</span></strong>
									
									<form method="post" action="">
										<input type="hidden" name="app" value="<?php echo $product["app"];?>">
										<input type="hidden" name="action" value="change">

										<select name="sun" onchange="this.form.submit()" class="form-control">
											<option <?php if($product["sun"]==1) echo "selected";?> value="1">1</option>
											
											<option <?php if($product["sun"]==2) echo "selected";?> value="2">2</option>
											
											<option <?php if($product["sun"]==3) echo "selected";?> value="3">3</option>
											
											<option <?php if($product["sun"]==4) echo "selected";?> value="4">4</option>
											
											<option <?php if($product["sun"]==5) echo "selected";?> value="5">5</option>

											<option <?php if($product["sun"]==6) echo "selected";?> value="6">6</option>
											
											<option <?php if($product["sun"]==7) echo "selected";?> value="7">7</option>
											
											<option <?php if($product["sun"]==8) echo "selected";?> value="8">8</option>
											
											<option <?php if($product["sun"]==9) echo "selected";?> value="9">9</option>
											
											<option <?php if($product["sun"]==10) echo "selected";?> value="10">10</option>
										</select>
									</form>
